...
namespace HW1
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            if(ValidDateTextBox.Text == "")
            {
                DateRequiredTxtLbl.Text = "Card valid date is required!";
            }
            if (CVCTextBox.Text == "")
            {
            ...
            else
            {
                ...
                Datevalid = ValidateCardDate(ValidDateTextBox.Text);
        ...
        protected void ValidDateTextBox_TextChanged(object sender, EventArgs e)
        {
            if (CardNumTextBox.Text != "")
            {
                CardValidDateLabel.Text = ValidDateTextBox.Text;
                DateRequiredTxtLbl.Text = "";
            }
            else
            {
                CardValidDateLabel.Text = "mm/yy";
            }   
        }
